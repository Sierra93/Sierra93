# Обо мне
Здравствуйте. Я Full-stack Middle+/Senior C# Developer с фокусом на Back-end. Опыт в разработке более 6 лет. Специализируюсь на разработке веб-приложений, клиент-серверных и мобильных приложений.
