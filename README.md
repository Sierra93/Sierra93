...
Есть опыт управления командой продукта среднего размера в своем стартапе Leoka Estetica (до 30 чел - бэк-разработчиками, фронт-разработчиками, дизайнерами, верстальщиками, системными аналитиками (есть понимание и про другие типы специализаций аналитиков при необходимости управлять и ими в команде)). В команде разработчики с квалификациями Junior и MIddle. Senior не заходили пока к нам, но имею понимание, как менеджить и разработчиками с такой высокой квалификацией. Тут я в роли CTO и имея роль ген.дира с партнером CEO, который в роли директора по стратегическому развитию и исполнительного директора.
