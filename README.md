...
2. Leoka.Estetica - Платформа для поиска команд, стартапов, управления проектами (доски задач и тд.) и создания ТЗ (техническое задание проекта) онлайн. Все на одной платформе. Собственный проект. <br>
