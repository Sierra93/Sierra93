...
**Исходный код находится в приватных репозиториях в GitLab (микросервисная архитектура). Инвайт по запросу, если это будет нужно. Мои самые сложные проекты находятся на собственном VPS GitLab-сервере.**
