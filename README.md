...
1. Garant.Platform - Сервис для покупки и продажи бизнеса и франшиз онлайн (стадия поиска инвестиций). Возможно вернусь на поддержку проекта (пока отошел без финансирования). Был тимлидом на этом проекте. <br> <br>
